                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="download_subtitle_url" class="block text-sm font-medium text-purple-800 mb-2">
                                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2h3a1 1 0 011 1v10a1 1 0 01-1 1H5a2 2 0 01-1-1V5a1 1 0 011-1h2z"></path>
...
<script>
// TinyMCE initialization - Fixed configuration
tinymce.init({
