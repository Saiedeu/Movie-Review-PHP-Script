...
<!-- TinyMCE Script - EXACT ExchangeBridge Working Pattern -->
...
<script>
// Get current directory path for upload handler - ExchangeBridge exact pattern
const currentPath = window.location.pathname;
const basePath = currentPath.substring(0, currentPath.lastIndexOf('/')) + '/';

// TinyMCE initialization - EXACT ExchangeBridge working configuration
tinymce.init({
    ...
    // Critical fixes - ExchangeBridge exact settings
    convert_urls: false,
    relative_urls: false,
    remove_script_host: false,
    document_base_url: '<?php echo SITE_URL; ?>/',
    
    // Image upload configuration - ExchangeBridge exact pattern
    ...
    // ExchangeBridge exact upload handler pattern
...
function updateUrlPreview() {
    ...
    function showPreview() {
        ...
        if (customUrl) {
            ...
            // Simple slug generation for preview (matches PHP generateSlug function)
        ...
        if (finalUrl) {
            previewUrl.textContent = '<?php echo SITE_URL; ?>/review/' + finalUrl;
