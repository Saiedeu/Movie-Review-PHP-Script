...
<div class="mb-8">
    <div class="flex items-center justify-between">
        ...
        <a href="../index.php" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm">
...
<script>
    ...
    function deleteComment(commentId) {
        if (!showConfirmDialog('আপনি কি নিশ্চিত যে এই মন্তব্যটি মুছে ফেলতে চান?')) {
            return;
        }
    ...
    function performBulkAction() {
        ...
        if (action === 'delete' && !showConfirmDialog(`আপনি কি নিশ্চিত যে ${selectedIds.length}টি মন্তব্য মুছে ফেলতে চান?`)) {
            return;
        }
        ...
        modal.innerHTML = `
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-sm w-full mx-4">
                ...
                <div class="flex justify-end space-x-3">
                    <button class="cancel-btn px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">বাতিল</button>
                    <button class="confirm-btn px-4 py-2 bg-red-500 text-white hover:bg-red-600 rounded">নিশ্চিত</button>
                </div>
            </div>
        `;
